...
| 项目 | 描述 | 更新频率 |
|------|------|----------|
| 🌀 [台风监控](./typhoon/) | 实时台风追踪、路径预报、风圈半径可视化 | 台风来临时生成 |
| 🌫️ [空气质量](./aqi/) | 广州 AQI、PM2.5、紫外线指数监测 | 每天5次 (08:35/12:35/16:35/20:35/00:35) |
| 🌐 [网站监控](./website/) | Kisara 主站和论坛可用率、响应时间 | 每天5次 (08:35/12:35/16:35/20:35/00:35) |
| 📋 [推送日志](./logs/) | GitHub Pages 部署记录和统计 | 每次推送后自动更新 |
| 📺 [追番列表](./anime/) | 本季新番时间表、今日更新提醒 | 每天 20:00 |

## 🚀 技术栈

- **前端**: HTML5 + CSS3 + Chart.js
- **数据源**: 和风天气 API / Bangumi 番组计划 / 自定义监控脚本
- **部署**: GitHub Pages
